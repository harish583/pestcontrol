    ...
    this.state ={
      services :{
        termitepestcontrolservices:{
          ...
          url:'/services/termitepestcontrolservices',
        ...
        cockroachpestcontrolservices:{
          ...
          url:'/services/cockroachpestcontrolservices',
        ...
        bedbugpestcontrolservices:{
          ...
          url:'/services/bedbugpestcontrolservices',
        ...
        antpestcontrolservices:{
          ...
          url:'/services/antpestcontrolservices',
        ...
        beepestcontrolservices:{
          ...
          url:'/services/beepestcontrolservices',
        ...
        spiderpestcontrolservices:{
          ...
          url:'/services/spiderpestcontrolservices',
        ...
        Rodentpestcontrolservices:{
          ...
          url:'/services/Rodentpestcontrolservices',
        ...
        snakepestcontrolservices:{
          ...
          url:'/services/snakepestcontrolservices',
        ...
        Mosquitopestcontrol:{
          ...
          url:'/services/Mosquitopestcontrol',
        ...
        Mosquitomeshservices:{
          ...
          url:'/services/Mosquitomeshservices',
        ...
        residentialpestcontrol:{
          ...
          url:'/services/residentialpestcontrol',
        ...
        Commericalpestcontrol:{
          ...
          url:'/services/Commericalpestcontrol',
        ...
        industrialpestcontrol:{
          ...
          url:'/services/industrialpestcontrol',
    ...
    return (
      <div className="BodyContent">
          <Switch>
            ...
            <Route path="/services/termitepestcontrolservices"><Service allServices={service} Service={service.termitepestcontrolservices}/></Route>
            <Route path="/services/cockroachpestcontrolservices"><Service allServices={service} Service={service.cockroachpestcontrolservices} /></Route>
            <Route path="/services/bedbugpestcontrolservices"><Service allServices={service} Service={service.bedbugpestcontrolservices} /></Route>
            <Route path="/services/antpestcontrolservices"><Service allServices={service} Service={service.antpestcontrolservices}/></Route>
            <Route path="/services/beepestcontrolservices"><Service allServices={service} Service={service.beepestcontrolservices} /></Route>
            <Route path="/services/spiderpestcontrolservices"><Service allServices={service} Service={service.spiderpestcontrolservices} /></Route>
            <Route path="/services/Rodentpestcontrolservices"><Service allServices={service} Service={service.Rodentpestcontrolservices}/></Route>
            <Route path="/services/snakepestcontrolservices"><Service allServices={service} Service={service.snakepestcontrolservices} /></Route>
            <Route path="/services/Mosquitopestcontrol"><Service allServices={service} Service={service.Mosquitopestcontrol} /></Route>
            <Route path="/services/Mosquitomeshservices"><Service allServices={service} Service={service.Mosquitomeshservices}/></Route>
            <Route path="/services/residentialpestcontrol"><Service allServices={service} Service={service.residentialpestcontrol} /></Route>
            <Route path="/services/Commericalpestcontrol"><Service allServices={service} Service={service.Commericalpestcontrol} /></Route>
            <Route path="/services/industrialpestcontrol"><Service allServices={service} Service={service.industrialpestcontrol} /></Route>
          </Switch>
      </div>
    );
  }
